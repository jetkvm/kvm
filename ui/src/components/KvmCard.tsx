...
export default function KvmCard({
   ...
   *
   * Version 0.5.0 is the last backwards-compatible UI that works with older devices.
   * Devices on v0.5.0 or below are served that version, while newer devices get
