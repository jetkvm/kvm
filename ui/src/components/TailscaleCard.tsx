        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-x-2">
              <h3 className="text-base font-bold text-slate-900 dark:text-white">{m.tailscale_title()}</h3>
            ...
            <div className="flex-1 space-y-2">
              {status.self.hostName && (
                <div className="flex justify-between border-slate-800/10 pt-2 dark:border-slate-300/20">
                  <span className="text-sm text-slate-600 dark:text-slate-400">{m.tailscale_hostname()}</span>
              ...
              {ipv4 && (
                <div className="flex justify-between border-t border-slate-800/10 pt-2 dark:border-slate-300/20">
                  <span className="text-sm text-slate-600 dark:text-slate-400">{m.tailscale_ipv4()}</span>
              ...
              {ipv6 && (
                <div className="flex justify-between border-t border-slate-800/10 pt-2 dark:border-slate-300/20">
                  <span className="text-sm text-slate-600 dark:text-slate-400">{m.tailscale_ipv6()}</span>
              ...
              {status.self.dnsName && (
                <div className="flex justify-between border-t border-slate-800/10 pt-2 dark:border-slate-300/20">
                  <span className="text-sm text-slate-600 dark:text-slate-400">{m.tailscale_dns_name()}</span>
          ...
          {!status.running && status.backendState !== "NeedsLogin" && (
            <p className="pt-2 text-sm text-slate-600 dark:text-slate-400">
              ...
              {status.backendState && m.tailscale_installed_not_running_state({ state: status.backendState })}
            </p>
          )}
        </div>
      </div>
