...
export default function KvmIdRoute() {
  ...
  const { microphoneEnabled, setMicrophoneEnabled, audioInputAutoEnable, setAudioInputAutoEnable, cameraEnabled, setCameraEnabled } = useSettingsStore();
  ...
  // Sync camera enabled state from device on connection (important for remote connections)
  useEffect(() => {
    if (rpcDataChannel?.readyState !== "open") return;
