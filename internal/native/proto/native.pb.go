...
type MjpegGetEnabledResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Enabled       bool                   `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *MjpegGetEnabledResponse) Reset() {
	*x = MjpegGetEnabledResponse{}
	mi := &file_internal_native_proto_native_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MjpegGetEnabledResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MjpegGetEnabledResponse) ProtoMessage() {}

func (x *MjpegGetEnabledResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_native_proto_native_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MjpegGetEnabledResponse.ProtoReflect.Descriptor instead.
func (*MjpegGetEnabledResponse) Descriptor() ([]byte, []int) {
	return file_internal_native_proto_native_proto_rawDescGZIP(), []int{13}
}

func (x *MjpegGetEnabledResponse) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
const file_internal_native_proto_native_proto_rawDesc = "" +
	...
	"\x17MjpegGetEnabledResponse\x12\x18\n" +
	...
	"\x0fMjpegSetEnabled\x12\x1e.native.MjpegSetEnabledRequest\x1a\r.native.Empty\x12A\n" +
	"\x0fMjpegGetEnabled\x12\r.native.Empty\x1a\x1f.native.MjpegGetEnabledResponse\x12?\n" +
...
var file_internal_native_proto_native_proto_goTypes = []any{
	...
	(*MjpegSetEnabledRequest)(nil),                // 12: native.MjpegSetEnabledRequest
	(*MjpegGetEnabledResponse)(nil),               // 13: native.MjpegGetEnabledResponse
...
var file_internal_native_proto_native_proto_depIdxs = []int32{
	...
	12, // 13: native.NativeService.MjpegSetEnabled:input_type -> native.MjpegSetEnabledRequest
	0,  // 14: native.NativeService.MjpegGetEnabled:input_type -> native.Empty
	...
	0,  // 42: native.NativeService.VideoSetEDID:output_type -> native.Empty
	10, // 43: native.NativeService.VideoGetEDID:output_type -> native.VideoGetEDIDResponse
	11, // 44: native.NativeService.VideoLogStatus:output_type -> native.VideoLogStatusResponse
	0,  // 45: native.NativeService.VideoStop:output_type -> native.Empty
	0,  // 46: native.NativeService.VideoStart:output_type -> native.Empty
	0,  // 47: native.NativeService.MjpegSetEnabled:output_type -> native.Empty
	13, // 48: native.NativeService.MjpegGetEnabled:output_type -> native.MjpegGetEnabledResponse
