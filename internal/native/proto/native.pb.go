...
type VideoCacheEDIDRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Edid          string                 `protobuf:"bytes,1,opt,name=edid,proto3" json:"edid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *VideoCacheEDIDRequest) Reset() {
	*x = VideoCacheEDIDRequest{}
	mi := &file_internal_native_proto_native_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VideoCacheEDIDRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VideoCacheEDIDRequest) ProtoMessage() {}

func (x *VideoCacheEDIDRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_native_proto_native_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VideoCacheEDIDRequest.ProtoReflect.Descriptor instead.
func (*VideoCacheEDIDRequest) Descriptor() ([]byte, []int) {
	return file_internal_native_proto_native_proto_rawDescGZIP(), []int{13}
}

func (x *VideoCacheEDIDRequest) GetEdid() string {
	if x != nil {
		return x.Edid
	}
	return ""
...
type VideoSetHotplugRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Enabled       bool                   `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *VideoSetHotplugRequest) Reset() {
	*x = VideoSetHotplugRequest{}
	mi := &file_internal_native_proto_native_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VideoSetHotplugRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VideoSetHotplugRequest) ProtoMessage() {}

func (x *VideoSetHotplugRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_native_proto_native_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VideoSetHotplugRequest.ProtoReflect.Descriptor instead.
func (*VideoSetHotplugRequest) Descriptor() ([]byte, []int) {
	return file_internal_native_proto_native_proto_rawDescGZIP(), []int{14}
}

func (x *VideoSetHotplugRequest) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
type VideoHotplugSupportedResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Supported     bool                   `protobuf:"varint,1,opt,name=supported,proto3" json:"supported,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *VideoHotplugSupportedResponse) Reset() {
	*x = VideoHotplugSupportedResponse{}
	mi := &file_internal_native_proto_native_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VideoHotplugSupportedResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VideoHotplugSupportedResponse) ProtoMessage() {}

func (x *VideoHotplugSupportedResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_native_proto_native_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VideoHotplugSupportedResponse.ProtoReflect.Descriptor instead.
func (*VideoHotplugSupportedResponse) Descriptor() ([]byte, []int) {
	return file_internal_native_proto_native_proto_rawDescGZIP(), []int{15}
}

func (x *VideoHotplugSupportedResponse) GetSupported() bool {
	if x != nil {
		return x.Supported
	}
	return false
...
const file_internal_native_proto_native_proto_rawDesc = "" +
	...
	"\x04edid\x18\x01 \x01(\tR\x04edid\"+\n" +
	"\x15VideoCacheEDIDRequest\x12\x12\n" +
	"\x04edid\x18\x01 \x01(\tR\x04edid\"2\n" +
	"\x16VideoSetHotplugRequest\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\"=\n" +
	"\x1dVideoHotplugSupportedResponse\x12\x1c\n" +
	"\tsupported\x18\x01 \x01(\bR\tsupported\"0\n" +
	...
	"\x0eVideoCacheEDID\x12\x1d.native.VideoCacheEDIDRequest\x1a\r.native.Empty\x12;\n" +
	"\fVideoGetEDID\x12\r.native.Empty\x1a\x1c.native.VideoGetEDIDResponse\x12@\n" +
	"\x0fVideoSetHotplug\x12\x1e.native.VideoSetHotplugRequest\x1a\r.native.Empty\x12M\n" +
	"\x15VideoHotplugSupported\x12\r.native.Empty\x1a%.native.VideoHotplugSupportedResponse\x12?\n" +
...
var file_internal_native_proto_native_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_internal_native_proto_native_proto_goTypes = []any{
	...
	(*VideoCacheEDIDRequest)(nil),                 // 13: native.VideoCacheEDIDRequest
	(*VideoSetHotplugRequest)(nil),                // 14: native.VideoSetHotplugRequest
	(*VideoHotplugSupportedResponse)(nil),         // 15: native.VideoHotplugSupportedResponse
	(*VideoLogStatusResponse)(nil),                // 16: native.VideoLogStatusResponse
...
var file_internal_native_proto_native_proto_depIdxs = []int32{
	...
	13, // 11: native.NativeService.VideoCacheEDID:input_type -> native.VideoCacheEDIDRequest
	0,  // 12: native.NativeService.VideoGetEDID:input_type -> native.Empty
	14, // 13: native.NativeService.VideoSetHotplug:input_type -> native.VideoSetHotplugRequest
	0,  // 14: native.NativeService.VideoHotplugSupported:input_type -> native.Empty
	0,  // 15: native.NativeService.VideoLogStatus:input_type -> native.Empty
	0,  // 16: native.NativeService.VideoStop:input_type -> native.Empty
	0,  // 17: native.NativeService.VideoStart:input_type -> native.Empty
	0,  // 18: native.NativeService.GetLVGLVersion:input_type -> native.Empty
	18, // 19: native.NativeService.UIObjHide:input_type -> native.UIObjHideRequest
	20, // 20: native.NativeService.UIObjShow:input_type -> native.UIObjShowRequest
	22, // 21: native.NativeService.UISetVar:input_type -> native.UISetVarRequest
	23, // 22: native.NativeService.UIGetVar:input_type -> native.UIGetVarRequest
	25, // 23: native.NativeService.UIObjAddState:input_type -> native.UIObjAddStateRequest
	27, // 24: native.NativeService.UIObjClearState:input_type -> native.UIObjClearStateRequest
	29, // 25: native.NativeService.UIObjAddFlag:input_type -> native.UIObjAddFlagRequest
	31, // 26: native.NativeService.UIObjClearFlag:input_type -> native.UIObjClearFlagRequest
	33, // 27: native.NativeService.UIObjSetOpacity:input_type -> native.UIObjSetOpacityRequest
	35, // 28: native.NativeService.UIObjFadeIn:input_type -> native.UIObjFadeInRequest
	37, // 29: native.NativeService.UIObjFadeOut:input_type -> native.UIObjFadeOutRequest
	39, // 30: native.NativeService.UIObjSetLabelText:input_type -> native.UIObjSetLabelTextRequest
	41, // 31: native.NativeService.UIObjSetImageSrc:input_type -> native.UIObjSetImageSrcRequest
	43, // 32: native.NativeService.DisplaySetRotation:input_type -> native.DisplaySetRotationRequest
	45, // 33: native.NativeService.UpdateLabelIfChanged:input_type -> native.UpdateLabelIfChangedRequest
	46, // 34: native.NativeService.UpdateLabelAndChangeVisibility:input_type -> native.UpdateLabelAndChangeVisibilityRequest
	47, // 35: native.NativeService.SwitchToScreenIf:input_type -> native.SwitchToScreenIfRequest
	48, // 36: native.NativeService.SwitchToScreenIfDifferent:input_type -> native.SwitchToScreenIfDifferentRequest
	0,  // 37: native.NativeService.DoNotUseThisIsForCrashTestingOnly:input_type -> native.Empty
	0,  // 38: native.NativeService.StreamEvents:input_type -> native.Empty
	2,  // 39: native.NativeService.IsReady:output_type -> native.IsReadyResponse
	0,  // 40: native.NativeService.VideoSetSleepMode:output_type -> native.Empty
	5,  // 41: native.NativeService.VideoGetSleepMode:output_type -> native.VideoGetSleepModeResponse
	6,  // 42: native.NativeService.VideoSleepModeSupported:output_type -> native.VideoSleepModeSupportedResponse
	0,  // 43: native.NativeService.VideoSetQualityFactor:output_type -> native.Empty
	8,  // 44: native.NativeService.VideoGetQualityFactor:output_type -> native.VideoGetQualityFactorResponse
	0,  // 45: native.NativeService.VideoSetCodecType:output_type -> native.Empty
	10, // 46: native.NativeService.VideoGetCodecType:output_type -> native.VideoGetCodecTypeResponse
	0,  // 47: native.NativeService.VideoSetEDID:output_type -> native.Empty
	0,  // 48: native.NativeService.VideoCacheEDID:output_type -> native.Empty
	12, // 49: native.NativeService.VideoGetEDID:output_type -> native.VideoGetEDIDResponse
	0,  // 50: native.NativeService.VideoSetHotplug:output_type -> native.Empty
	15, // 51: native.NativeService.VideoHotplugSupported:output_type -> native.VideoHotplugSupportedResponse
	16, // 52: native.NativeService.VideoLogStatus:output_type -> native.VideoLogStatusResponse
	...
	17, // 55: native.NativeService.GetLVGLVersion:output_type -> native.GetLVGLVersionResponse
	19, // 56: native.NativeService.UIObjHide:output_type -> native.UIObjHideResponse
	21, // 57: native.NativeService.UIObjShow:output_type -> native.UIObjShowResponse
	0,  // 58: native.NativeService.UISetVar:output_type -> native.Empty
	24, // 59: native.NativeService.UIGetVar:output_type -> native.UIGetVarResponse
	26, // 60: native.NativeService.UIObjAddState:output_type -> native.UIObjAddStateResponse
	28, // 61: native.NativeService.UIObjClearState:output_type -> native.UIObjClearStateResponse
	30, // 62: native.NativeService.UIObjAddFlag:output_type -> native.UIObjAddFlagResponse
	32, // 63: native.NativeService.UIObjClearFlag:output_type -> native.UIObjClearFlagResponse
	34, // 64: native.NativeService.UIObjSetOpacity:output_type -> native.UIObjSetOpacityResponse
	36, // 65: native.NativeService.UIObjFadeIn:output_type -> native.UIObjFadeInResponse
	38, // 66: native.NativeService.UIObjFadeOut:output_type -> native.UIObjFadeOutResponse
	40, // 67: native.NativeService.UIObjSetLabelText:output_type -> native.UIObjSetLabelTextResponse
	42, // 68: native.NativeService.UIObjSetImageSrc:output_type -> native.UIObjSetImageSrcResponse
	44, // 69: native.NativeService.DisplaySetRotation:output_type -> native.DisplaySetRotationResponse
	0,  // 70: native.NativeService.UpdateLabelIfChanged:output_type -> native.Empty
	0,  // 71: native.NativeService.UpdateLabelAndChangeVisibility:output_type -> native.Empty
	0,  // 72: native.NativeService.SwitchToScreenIf:output_type -> native.Empty
	0,  // 73: native.NativeService.SwitchToScreenIfDifferent:output_type -> native.Empty
	0,  // 74: native.NativeService.DoNotUseThisIsForCrashTestingOnly:output_type -> native.Empty
	49, // 75: native.NativeService.StreamEvents:output_type -> native.Event
