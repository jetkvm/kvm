...
func (x *VideoGetJPEGResponse) Reset() {
	*x = VideoGetJPEGResponse{}
	mi := &file_internal_native_proto_native_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VideoGetJPEGResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VideoGetJPEGResponse) ProtoMessage() {}

func (x *VideoGetJPEGResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_native_proto_native_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VideoGetJPEGResponse.ProtoReflect.Descriptor instead.
func (*VideoGetJPEGResponse) Descriptor() ([]byte, []int) {
	return file_internal_native_proto_native_proto_rawDescGZIP(), []int{4}
}

func (x *VideoGetJPEGResponse) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_internal_native_proto_native_proto_goTypes = []any{
	...
	(*VideoGetJPEGResponse)(nil),                  // 4: native.VideoGetJPEGResponse
	(*VideoSetSleepModeRequest)(nil),              // 5: native.VideoSetSleepModeRequest
	(*VideoGetSleepModeResponse)(nil),             // 6: native.VideoGetSleepModeResponse
	(*VideoSleepModeSupportedResponse)(nil),       // 7: native.VideoSleepModeSupportedResponse
	(*VideoSetQualityFactorRequest)(nil),          // 8: native.VideoSetQualityFactorRequest
	(*VideoGetQualityFactorResponse)(nil),         // 9: native.VideoGetQualityFactorResponse
	(*VideoSetCodecTypeRequest)(nil),              // 10: native.VideoSetCodecTypeRequest
	(*VideoGetCodecTypeResponse)(nil),             // 11: native.VideoGetCodecTypeResponse
	(*VideoSetEDIDRequest)(nil),                   // 12: native.VideoSetEDIDRequest
	(*VideoGetEDIDResponse)(nil),                  // 13: native.VideoGetEDIDResponse
	(*VideoLogStatusResponse)(nil),                // 14: native.VideoLogStatusResponse
...
var file_internal_native_proto_native_proto_depIdxs = []int32{
	...
	8,  // 6: native.NativeService.VideoSetQualityFactor:input_type -> native.VideoSetQualityFactorRequest
	0,  // 7: native.NativeService.VideoGetQualityFactor:input_type -> native.Empty
	10, // 8: native.NativeService.VideoSetCodecType:input_type -> native.VideoSetCodecTypeRequest
	0,  // 9: native.NativeService.VideoGetCodecType:input_type -> native.Empty
	12, // 10: native.NativeService.VideoSetEDID:input_type -> native.VideoSetEDIDRequest
	...
	0,  // 15: native.NativeService.VideoGetJPEG:input_type -> native.Empty
	0,  // 16: native.NativeService.GetLVGLVersion:input_type -> native.Empty
	16, // 17: native.NativeService.UIObjHide:input_type -> native.UIObjHideRequest
	18, // 18: native.NativeService.UIObjShow:input_type -> native.UIObjShowRequest
	20, // 19: native.NativeService.UISetVar:input_type -> native.UISetVarRequest
	21, // 20: native.NativeService.UIGetVar:input_type -> native.UIGetVarRequest
	23, // 21: native.NativeService.UIObjAddState:input_type -> native.UIObjAddStateRequest
	25, // 22: native.NativeService.UIObjClearState:input_type -> native.UIObjClearStateRequest
	27, // 23: native.NativeService.UIObjAddFlag:input_type -> native.UIObjAddFlagRequest
	29, // 24: native.NativeService.UIObjClearFlag:input_type -> native.UIObjClearFlagRequest
	31, // 25: native.NativeService.UIObjSetOpacity:input_type -> native.UIObjSetOpacityRequest
	33, // 26: native.NativeService.UIObjFadeIn:input_type -> native.UIObjFadeInRequest
	35, // 27: native.NativeService.UIObjFadeOut:input_type -> native.UIObjFadeOutRequest
	37, // 28: native.NativeService.UIObjSetLabelText:input_type -> native.UIObjSetLabelTextRequest
	39, // 29: native.NativeService.UIObjSetImageSrc:input_type -> native.UIObjSetImageSrcRequest
	41, // 30: native.NativeService.DisplaySetRotation:input_type -> native.DisplaySetRotationRequest
	43, // 31: native.NativeService.UpdateLabelIfChanged:input_type -> native.UpdateLabelIfChangedRequest
	44, // 32: native.NativeService.UpdateLabelAndChangeVisibility:input_type -> native.UpdateLabelAndChangeVisibilityRequest
	45, // 33: native.NativeService.SwitchToScreenIf:input_type -> native.SwitchToScreenIfRequest
	46, // 34: native.NativeService.SwitchToScreenIfDifferent:input_type -> native.SwitchToScreenIfDifferentRequest
	...
	0,  // 38: native.NativeService.VideoSetSleepMode:output_type -> native.Empty
	6,  // 39: native.NativeService.VideoGetSleepMode:output_type -> native.VideoGetSleepModeResponse
	7,  // 40: native.NativeService.VideoSleepModeSupported:output_type -> native.VideoSleepModeSupportedResponse
	0,  // 41: native.NativeService.VideoSetQualityFactor:output_type -> native.Empty
	9,  // 42: native.NativeService.VideoGetQualityFactor:output_type -> native.VideoGetQualityFactorResponse
	0,  // 43: native.NativeService.VideoSetCodecType:output_type -> native.Empty
	11, // 44: native.NativeService.VideoGetCodecType:output_type -> native.VideoGetCodecTypeResponse
	0,  // 45: native.NativeService.VideoSetEDID:output_type -> native.Empty
	13, // 46: native.NativeService.VideoGetEDID:output_type -> native.VideoGetEDIDResponse
	14, // 47: native.NativeService.VideoLogStatus:output_type -> native.VideoLogStatusResponse
	0,  // 48: native.NativeService.VideoStop:output_type -> native.Empty
	0,  // 49: native.NativeService.VideoStart:output_type -> native.Empty
	4,  // 50: native.NativeService.VideoGetJPEG:output_type -> native.VideoGetJPEGResponse
	15, // 51: native.NativeService.GetLVGLVersion:output_type -> native.GetLVGLVersionResponse
	17, // 52: native.NativeService.UIObjHide:output_type -> native.UIObjHideResponse
	19, // 53: native.NativeService.UIObjShow:output_type -> native.UIObjShowResponse
	0,  // 54: native.NativeService.UISetVar:output_type -> native.Empty
	22, // 55: native.NativeService.UIGetVar:output_type -> native.UIGetVarResponse
	24, // 56: native.NativeService.UIObjAddState:output_type -> native.UIObjAddStateResponse
	26, // 57: native.NativeService.UIObjClearState:output_type -> native.UIObjClearStateResponse
	28, // 58: native.NativeService.UIObjAddFlag:output_type -> native.UIObjAddFlagResponse
	30, // 59: native.NativeService.UIObjClearFlag:output_type -> native.UIObjClearFlagResponse
	32, // 60: native.NativeService.UIObjSetOpacity:output_type -> native.UIObjSetOpacityResponse
	34, // 61: native.NativeService.UIObjFadeIn:output_type -> native.UIObjFadeInResponse
	36, // 62: native.NativeService.UIObjFadeOut:output_type -> native.UIObjFadeOutResponse
	38, // 63: native.NativeService.UIObjSetLabelText:output_type -> native.UIObjSetLabelTextResponse
	...
	47, // 71: native.NativeService.StreamEvents:output_type -> native.Event
