...
type VideoGetSnapshotResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *VideoGetSnapshotResponse) Reset() {
	*x = VideoGetSnapshotResponse{}
	mi := &file_internal_native_proto_native_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VideoGetSnapshotResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VideoGetSnapshotResponse) ProtoMessage() {}

func (x *VideoGetSnapshotResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_native_proto_native_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VideoGetSnapshotResponse.ProtoReflect.Descriptor instead.
func (*VideoGetSnapshotResponse) Descriptor() ([]byte, []int) {
	return file_internal_native_proto_native_proto_rawDescGZIP(), []int{14}
}

func (x *VideoGetSnapshotResponse) GetJpeg() []byte {
	if x != nil {
		return x.Jpeg
	}
	return nil
...
// Receiver estimate in bits per second; zero clears the limit.
type VideoSetREMBRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *VideoSetREMBRequest) Reset() {
	*x = VideoSetREMBRequest{}
	mi := &file_internal_native_proto_native_proto_msgTypes[49]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VideoSetREMBRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VideoSetREMBRequest) ProtoMessage() {}

func (x *VideoSetREMBRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_native_proto_native_proto_msgTypes[49]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VideoSetREMBRequest.ProtoReflect.Descriptor instead.
func (*VideoSetREMBRequest) Descriptor() ([]byte, []int) {
	return file_internal_native_proto_native_proto_rawDescGZIP(), []int{49}
}

func (x *VideoSetREMBRequest) GetBitrate() uint32 {
	if x != nil {
		return x.Bitrate
	}
	return 0
...
const file_internal_native_proto_native_proto_rawDesc = "" +
	...
	"durationNs\"/\n" +
	"\x13VideoSetREMBRequest\x12\x18\n" +
	"\abitrate\x18\x01 \x01(\rR\abitrate2\x8b\x14\n" +
	"\rNativeService\x12:\n" +
	"\aIsReady\x12\x16.native.IsReadyRequest\x1a\x17.native.IsReadyResponse\x12:\n" +
	"\fVideoSetREMB\x12\x1b.native.VideoSetREMBRequest\x1a\r.native.Empty\x12D\n" +
...
var file_internal_native_proto_native_proto_msgTypes = make([]protoimpl.MessageInfo, 50)
var file_internal_native_proto_native_proto_goTypes = []any{
	...
	(*VideoGetSnapshotResponse)(nil),              // 14: native.VideoGetSnapshotResponse
	(*GetLVGLVersionResponse)(nil),                // 15: native.GetLVGLVersionResponse
	(*UIObjHideRequest)(nil),                      // 16: native.UIObjHideRequest
	(*UIObjHideResponse)(nil),                     // 17: native.UIObjHideResponse
	(*UIObjShowRequest)(nil),                      // 18: native.UIObjShowRequest
	(*UIObjShowResponse)(nil),                     // 19: native.UIObjShowResponse
	(*UISetVarRequest)(nil),                       // 20: native.UISetVarRequest
	(*UIGetVarRequest)(nil),                       // 21: native.UIGetVarRequest
	(*UIGetVarResponse)(nil),                      // 22: native.UIGetVarResponse
	(*UIObjAddStateRequest)(nil),                  // 23: native.UIObjAddStateRequest
	(*UIObjAddStateResponse)(nil),                 // 24: native.UIObjAddStateResponse
	(*UIObjClearStateRequest)(nil),                // 25: native.UIObjClearStateRequest
	(*UIObjClearStateResponse)(nil),               // 26: native.UIObjClearStateResponse
	(*UIObjAddFlagRequest)(nil),                   // 27: native.UIObjAddFlagRequest
	(*UIObjAddFlagResponse)(nil),                  // 28: native.UIObjAddFlagResponse
	(*UIObjClearFlagRequest)(nil),                 // 29: native.UIObjClearFlagRequest
	(*UIObjClearFlagResponse)(nil),                // 30: native.UIObjClearFlagResponse
	(*UIObjSetOpacityRequest)(nil),                // 31: native.UIObjSetOpacityRequest
	(*UIObjSetOpacityResponse)(nil),               // 32: native.UIObjSetOpacityResponse
	(*UIObjFadeInRequest)(nil),                    // 33: native.UIObjFadeInRequest
	(*UIObjFadeInResponse)(nil),                   // 34: native.UIObjFadeInResponse
	(*UIObjFadeOutRequest)(nil),                   // 35: native.UIObjFadeOutRequest
	(*UIObjFadeOutResponse)(nil),                  // 36: native.UIObjFadeOutResponse
	(*UIObjSetLabelTextRequest)(nil),              // 37: native.UIObjSetLabelTextRequest
	(*UIObjSetLabelTextResponse)(nil),             // 38: native.UIObjSetLabelTextResponse
	(*UIObjSetImageSrcRequest)(nil),               // 39: native.UIObjSetImageSrcRequest
	(*UIObjSetImageSrcResponse)(nil),              // 40: native.UIObjSetImageSrcResponse
	...
	(*UpdateLabelAndChangeVisibilityRequest)(nil), // 44: native.UpdateLabelAndChangeVisibilityRequest
	(*SwitchToScreenIfRequest)(nil),               // 45: native.SwitchToScreenIfRequest
	(*SwitchToScreenIfDifferentRequest)(nil),      // 46: native.SwitchToScreenIfDifferentRequest
	(*Event)(nil),                                 // 47: native.Event
	(*VideoFrame)(nil),                            // 48: native.VideoFrame
	(*VideoSetREMBRequest)(nil),                   // 49: native.VideoSetREMBRequest
}
var file_internal_native_proto_native_proto_depIdxs = []int32{
	3,  // 0: native.Event.video_state:type_name -> native.VideoState
	48, // 1: native.Event.video_frame:type_name -> native.VideoFrame
	1,  // 2: native.NativeService.IsReady:input_type -> native.IsReadyRequest
	49, // 3: native.NativeService.VideoSetREMB:input_type -> native.VideoSetREMBRequest
	...
	9,  // 9: native.NativeService.VideoSetCodecType:input_type -> native.VideoSetCodecTypeRequest
	0,  // 10: native.NativeService.VideoGetCodecType:input_type -> native.Empty
	11, // 11: native.NativeService.VideoSetEDID:input_type -> native.VideoSetEDIDRequest
	0,  // 12: native.NativeService.VideoGetEDID:input_type -> native.Empty
	0,  // 13: native.NativeService.VideoLogStatus:input_type -> native.Empty
	0,  // 14: native.NativeService.VideoStop:input_type -> native.Empty
	0,  // 15: native.NativeService.VideoStart:input_type -> native.Empty
	0,  // 16: native.NativeService.VideoGetSnapshot:input_type -> native.Empty
	0,  // 17: native.NativeService.GetLVGLVersion:input_type -> native.Empty
	16, // 18: native.NativeService.UIObjHide:input_type -> native.UIObjHideRequest
	18, // 19: native.NativeService.UIObjShow:input_type -> native.UIObjShowRequest
	20, // 20: native.NativeService.UISetVar:input_type -> native.UISetVarRequest
	21, // 21: native.NativeService.UIGetVar:input_type -> native.UIGetVarRequest
	23, // 22: native.NativeService.UIObjAddState:input_type -> native.UIObjAddStateRequest
	25, // 23: native.NativeService.UIObjClearState:input_type -> native.UIObjClearStateRequest
	27, // 24: native.NativeService.UIObjAddFlag:input_type -> native.UIObjAddFlagRequest
	29, // 25: native.NativeService.UIObjClearFlag:input_type -> native.UIObjClearFlagRequest
	31, // 26: native.NativeService.UIObjSetOpacity:input_type -> native.UIObjSetOpacityRequest
	33, // 27: native.NativeService.UIObjFadeIn:input_type -> native.UIObjFadeInRequest
	35, // 28: native.NativeService.UIObjFadeOut:input_type -> native.UIObjFadeOutRequest
	37, // 29: native.NativeService.UIObjSetLabelText:input_type -> native.UIObjSetLabelTextRequest
	39, // 30: native.NativeService.UIObjSetImageSrc:input_type -> native.UIObjSetImageSrcRequest
	41, // 31: native.NativeService.DisplaySetRotation:input_type -> native.DisplaySetRotationRequest
	43, // 32: native.NativeService.UpdateLabelIfChanged:input_type -> native.UpdateLabelIfChangedRequest
	44, // 33: native.NativeService.UpdateLabelAndChangeVisibility:input_type -> native.UpdateLabelAndChangeVisibilityRequest
	45, // 34: native.NativeService.SwitchToScreenIf:input_type -> native.SwitchToScreenIfRequest
	46, // 35: native.NativeService.SwitchToScreenIfDifferent:input_type -> native.SwitchToScreenIfDifferentRequest
	0,  // 36: native.NativeService.DoNotUseThisIsForCrashTestingOnly:input_type -> native.Empty
	0,  // 37: native.NativeService.StreamEvents:input_type -> native.Empty
	2,  // 38: native.NativeService.IsReady:output_type -> native.IsReadyResponse
	0,  // 39: native.NativeService.VideoSetREMB:output_type -> native.Empty
	...
	12, // 48: native.NativeService.VideoGetEDID:output_type -> native.VideoGetEDIDResponse
	13, // 49: native.NativeService.VideoLogStatus:output_type -> native.VideoLogStatusResponse
	...
	14, // 52: native.NativeService.VideoGetSnapshot:output_type -> native.VideoGetSnapshotResponse
	15, // 53: native.NativeService.GetLVGLVersion:output_type -> native.GetLVGLVersionResponse
	17, // 54: native.NativeService.UIObjHide:output_type -> native.UIObjHideResponse
	19, // 55: native.NativeService.UIObjShow:output_type -> native.UIObjShowResponse
	0,  // 56: native.NativeService.UISetVar:output_type -> native.Empty
	22, // 57: native.NativeService.UIGetVar:output_type -> native.UIGetVarResponse
	24, // 58: native.NativeService.UIObjAddState:output_type -> native.UIObjAddStateResponse
	26, // 59: native.NativeService.UIObjClearState:output_type -> native.UIObjClearStateResponse
	28, // 60: native.NativeService.UIObjAddFlag:output_type -> native.UIObjAddFlagResponse
	30, // 61: native.NativeService.UIObjClearFlag:output_type -> native.UIObjClearFlagResponse
	32, // 62: native.NativeService.UIObjSetOpacity:output_type -> native.UIObjSetOpacityResponse
	34, // 63: native.NativeService.UIObjFadeIn:output_type -> native.UIObjFadeInResponse
	36, // 64: native.NativeService.UIObjFadeOut:output_type -> native.UIObjFadeOutResponse
	38, // 65: native.NativeService.UIObjSetLabelText:output_type -> native.UIObjSetLabelTextResponse
	40, // 66: native.NativeService.UIObjSetImageSrc:output_type -> native.UIObjSetImageSrcResponse
	42, // 67: native.NativeService.DisplaySetRotation:output_type -> native.DisplaySetRotationResponse
	0,  // 68: native.NativeService.UpdateLabelIfChanged:output_type -> native.Empty
	0,  // 69: native.NativeService.UpdateLabelAndChangeVisibility:output_type -> native.Empty
	0,  // 70: native.NativeService.SwitchToScreenIf:output_type -> native.Empty
	0,  // 71: native.NativeService.SwitchToScreenIfDifferent:output_type -> native.Empty
	0,  // 72: native.NativeService.DoNotUseThisIsForCrashTestingOnly:output_type -> native.Empty
	47, // 73: native.NativeService.StreamEvents:output_type -> native.Event
...
func file_internal_native_proto_native_proto_init() {
	...
	file_internal_native_proto_native_proto_msgTypes[47].OneofWrappers = []any{
