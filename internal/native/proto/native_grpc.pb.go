...
const (
	...
	NativeService_VideoGetJPEG_FullMethodName                      = "/native.NativeService/VideoGetJPEG"
...
type NativeServiceClient interface {
	...
	VideoGetJPEG(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*VideoGetJPEGResponse, error)
	// UI methods
...
func (c *nativeServiceClient) VideoGetJPEG(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*VideoGetJPEGResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VideoGetJPEGResponse)
	err := c.cc.Invoke(ctx, NativeService_VideoGetJPEG_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NativeServiceServer interface {
	...
	VideoGetJPEG(context.Context, *Empty) (*VideoGetJPEGResponse, error)
	// UI methods
...
func (UnimplementedNativeServiceServer) VideoGetJPEG(context.Context, *Empty) (*VideoGetJPEGResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VideoGetJPEG not implemented")
}
...
func _NativeService_VideoGetJPEG_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NativeServiceServer).VideoGetJPEG(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NativeService_VideoGetJPEG_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NativeServiceServer).VideoGetJPEG(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NativeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VideoGetJPEG",
			Handler:    _NativeService_VideoGetJPEG_Handler,
		},
		{
