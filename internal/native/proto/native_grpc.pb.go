...
const (
	...
	NativeService_MjpegGetEnabled_FullMethodName                   = "/native.NativeService/MjpegGetEnabled"
...
type NativeServiceClient interface {
	...
	MjpegGetEnabled(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*MjpegGetEnabledResponse, error)
	// UI methods
...
func (c *nativeServiceClient) MjpegGetEnabled(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*MjpegGetEnabledResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MjpegGetEnabledResponse)
	err := c.cc.Invoke(ctx, NativeService_MjpegGetEnabled_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NativeServiceServer interface {
	...
	MjpegGetEnabled(context.Context, *Empty) (*MjpegGetEnabledResponse, error)
	// UI methods
...
func (UnimplementedNativeServiceServer) MjpegGetEnabled(context.Context, *Empty) (*MjpegGetEnabledResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MjpegGetEnabled not implemented")
}
...
func _NativeService_MjpegGetEnabled_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NativeServiceServer).MjpegGetEnabled(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NativeService_MjpegGetEnabled_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NativeServiceServer).MjpegGetEnabled(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NativeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MjpegGetEnabled",
			Handler:    _NativeService_MjpegGetEnabled_Handler,
		},
		{
