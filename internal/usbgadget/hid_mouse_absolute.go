...
func (u *UsbGadget) absMouseWriteHidFile(data []byte) error {
	if u.absMouseHidFile == nil {
		var err error
		if u.absMouseHidFile, err = os.OpenFile("/dev/hidg1", os.O_WRONLY, 0666); err != nil {
	...
	if err != nil {
		u.logWithSuppression(u.getHidMouseLoggingContext().Str("file", u.absMouseHidFile.Name()), "absMouseWriteHidFile", 10, err, "failed to write absolute mouse")
