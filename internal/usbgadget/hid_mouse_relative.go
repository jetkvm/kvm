...
func (u *UsbGadget) relMouseWriteHidFile(data []byte) error {
	if u.relMouseHidFile == nil {
		var err error
		if u.relMouseHidFile, err = os.OpenFile("/dev/hidg2", os.O_WRONLY, 0666); err != nil {
	...
	if err != nil {
		u.logWithSuppression(u.getHidMouseLoggingContext().Str("file", u.relMouseHidFile.Name()), "relMouseWriteHidFile", 10, err, "failed to write relative mouse")
