...
/* Source: Luckfox Pico kernel (RV1106 SoC, same as JetKVM)
 * https://github.com/LuckfoxTECH/luckfox-pico/blob/5.10.110/sysdrv/source/kernel/include/uapi/linux/cryptodev.h
 *
 * This header provides the userspace API for /dev/crypto hardware acceleration.
 * It includes Rockchip-specific algorithm definitions (CRYPTO_RK_*) for the
 * RV1106 crypto accelerator used by OpenSSL's devcrypto engine.
 */
...
enum cryptodev_crypto_op_t {
	...
	/* Rockchip-specific algorithms for RV1106 crypto accelerator */
